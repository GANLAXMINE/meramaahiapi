                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Reason Report</h6>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center mb-0 data-tables">
                                <thead style="text-align: center">
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Reported User</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Reporting User</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Question</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Answer</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Message</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Reporting Date And Time</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fullDescriptionModalLabel">Message</h5>
...
<script>
    $(function() {
        var table = $('.data-tables').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'reason_question_id',
                    name: 'reason_question_id',
                },
                {
                    data: 'reason_subquestion_id',
                    name: 'reason_subquestion_id',
                },
                {
                    data: 'message',
                    name: 'message',
        ...
        $('.data-tables').on('click', '.btnDelete', function(e) {
            ...
            swal.fire({
                title: "Are you sure want to remove this questions?",
    ...
    function showFullMessage(button) {
        var fullMessage = $(button).siblings('.full-message').text();
        $('.full-description-modal-content').text(fullMessage);

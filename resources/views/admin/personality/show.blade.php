        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Personality
                    <li>
                </ol>
            </nav>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                            <a href="{{ url('/admin/personalities') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Back</button></a>

                            {!! Form::open([
                            'method' => 'DELETE',
                            'url' => ['/admin/personalities', $personality->id],
                            ...
                            <!-- <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <th>Slug</th>
                                            <td class='font-weight-bold'> {{ $personality->slug }} </td>
                                        </tr>
                                        <tr>
                                            <th>Decriptions</th>
                                            <td class='font-weight-bold'> {{ $personality->description }} </td>
                                        </tr>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> {{ $personality->slug }} </td>
                                        </tr>
                                        <tr>
                                            <th>Long Description</th>
                                            <td class="full-description"> {{ $personality->description_en }} </td>
                                        </tr>
                                        <tr>
                                            <th>Short Description</th>
                                            <td class="full-description"> {{ $personality->short_description_en }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

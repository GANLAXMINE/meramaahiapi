                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                             <a href="{{URL::to('admin/survey_questions/create')}}" class="btn btn-success btn-sm" title="Add New User">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Questions
                            </a> 
                            <table class="table align-items-center mb-0 data-tables">
                                <thead style="text-align: center">
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Category</th>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Question Types</th>
...
<script>
    $(function() {
        var table = $('.data-tables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('admin/survey_questions') }}",
            columns: [{
                    data: null,
                    name: 'id',

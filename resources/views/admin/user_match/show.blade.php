                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown px-3 d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-1 py-2 me-sm-n4"
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-3">
                                <a href="{{ url('/admin/user/list') }}" title="Back"><button
                                ...
                                @if ($user->verification_image != null)
                                    @if ($user->verification_status == '1')
                                        <button class="btn btn-success btn-sm" disabled id="approved_verify"><i
                                                class="fa fa-pencil-square-o" aria-hidden="true"></i> Verified</button>
                                    @elseif ($user->verification_status == '2')
                                        <button class="btn btn-danger btn-sm" disabled id="approved_verify"><i
                                                class="fa fa-pencil-square-o" aria-hidden="true"></i> Rejected</button>
                                    @else
                                        <button class="btn btn-success btn-sm changeStatus"
                                            data-value ="{{ $user->id }}" data-status="1"><i
                                                class="fa fa-pencil-square-o" aria-hidden="true"></i> Verify</button>
                                        <button class="btn btn-danger btn-sm changeStatus"
                                            data-value ="{{ $user->id }}" data-status="2"><i
                                                class="fa fa-pencil-square-o" aria-hidden="true"></i> Reject</button>
                                    @endif
                                @endif
                                <br />
                                <br />
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            {{-- <tr>
                                                <th>DOB</th>
                                                <td class='font-weight-bold'> {{ $user->dob }} </td>
                                            </tr> --}}
                                            <tr>
                                                <th>Apple ID</th>
                                            ...
                                            {{-- <tr><th>Status</th><td class='font-weight-bold'> {!! $user->status ? 'Enabled': 'Disabled'!!}</td></tr> --}}
                                            <tr>
                                                <th>Profile Image</th>
                                                <td class='font-weight-bold '>
                                                    @if ($prifile_images!=null)
                                                        <img src="{{ URL::to($prifile_images->image) }}"
                                                            class="img-thumbnail img-responsive w-10 imageEnlarge1">
                                                    @else
                                                        NA
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class='font-weight-bold image_wrap'>
                                                    @if ($user->verification_image != null)
                                                        <img src="{{ URL::to($user->verification_image) }}"
                                                            class="img-thumbnail img-responsive imageEnlarge2">

                                                        <img src="{{ url('img/sample_verify_img.png') }}"
                                                            class="img-thumbnail img-responsive imageEnlarge2">
                                                    @else
                                                        NA
                                                    @endif

        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Date Expectations
                    <li>
                </ol>
            </nav>
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Date Expectations</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                            <a href="{{ url('/admin/date-expectations') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Back</button></a>

                            {!! Form::open([
                            'method' => 'DELETE',
                            'url' => ['/admin/date-expectations', $expections->id],
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <th>Question</th>
                                            <td> {{ $expections->questions }} </td>
                                        </tr>
                                        <tr>
                                            <th>Option 1</th>
                                            <td class="full-description"> {{ $expections->options[0]->option }} </td>
                                        </tr>
                                        <tr>
                                            <th>Option 2</th>
                                            <td class="full-description"> {{ $expections->options[1]->option  }} </td>
                                        </tr>
                                        <tr>
                                            <th>Option 3</th>
                                            <td class="full-description"> {{ $expections->options[2]->option }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Date Expectations
                            </a></h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                            <!-- <a href="{{URL::to('admin/date-expectations/create')}}" class="btn btn-success btn-sm" title="Add New User">
                                <i class="fa fa-plus" aria-hidden="true"></i> Add Date Expectations
                            </a> -->
                            <table class="table align-items-center mb-0 data-tables">
                                <thead style="text-align: center">
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Questions</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option 1</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option 2</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bold text-dark">Option 3</th>
...
<script>
    $(function() {
        var table = $('.data-tables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('admin/date-expectations') }}",
            columns: [{
                    data: null,
                    name: 'id',

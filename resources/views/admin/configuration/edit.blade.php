        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Configuration
                    <li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Configuration<h6>
            </nav>
...
<!-- Your Summernote initialization script -->
<script>
    $('textarea.summernote_tos').summernote({
    ...
    $('textarea.summernote_pp').summernote({
        placeholder: 'Hello bootstrap 4',
        tabsize: 2,
        height: 300,
        toolbar: [
    ...
    $('textarea.summernote_au').summernote({
        placeholder: 'Hello bootstrap 4',
        tabsize: 2,
        height: 300,
        toolbar: [

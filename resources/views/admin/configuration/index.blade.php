            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    ...
                    <div class="input-group input-group-outline" style="margin-top: 15px;">
                        ...
                        <input type="text" class="form-control" name="search" style="height:40px;" value="{{ request('search') }}">
            ...
            <div class="row">
                ...
                <div class="card my-4">
                    ...
                    <div class="table-responsive p-3">
                        {{-- <a href="{{ url('/admin/categories/create') }}" class="btn btn-success btn-sm" title="Add New User">
                        ...
                        <thead style="text-align: center">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">About Us</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Terms And Conditions</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Privacy Policy</th>
                        ...
                        <div class="pagination"> {!! $configuration->links('pagination::bootstrap-4') !!} </div>
                    </div>
                    </div>
                </div>
                </div>

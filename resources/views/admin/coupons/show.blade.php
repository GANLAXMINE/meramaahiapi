        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Coupon
                    <li>
                </ol>
            </nav>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                            <a href="{{ url('/admin/coupons') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Back</button></a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <th>Name</th>
                                            <td class='font-weight-bold'> {{ $coupons->name }} </td>
                                        </tr>
                                        <tr>
                                            <th>Description</th>
                                            <td class='font-weight-bold'> {{ $coupons->description }} </td>
                                        </tr>
                                        <tr>
                                            <th>Code</th>
                                            <td class='font-weight-bold'> {{ $coupons->code }} </td>
                                        </tr>
                                        <tr>
                                            <th>Type</th>
                                            <td class='font-weight-bold'> {{ $coupons->type }} </td>
                                        </tr>
                                        <tr>
                                            <th>Discount Amount</th>
                                            <td class='font-weight-bold'> {{ $coupons->discount_amount }} </td>
                                        </tr>
                                        <tr>
                                            <th>Min Amount</th>
                                            <td class='font-weight-bold'> {!! $coupons->min_amount ? $coupons->min_amount : 'NA' !!}</td>
                                        </tr>
                                        <tr>
                                            <th>Start Date</th>
                                            <td class='font-weight-bold'>{{ date('Y-m-d', strtotime($coupons->start_date)) }}  </td>
                                        </tr>
                                        <tr>
                                            <th>End Date</th>
                                            <td class='font-weight-bold'>  {{ date('Y-m-d', strtotime($coupons->end_date)) }}  </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

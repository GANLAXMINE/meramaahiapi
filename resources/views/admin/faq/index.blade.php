                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Faq</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-3">
                            <a href="{{URL::to('admin/faq/create')}}" class="btn btn-success btn-sm" title="Add New User">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fullDescriptionModalLabel">Answer</h5>
...
<script>
    function showFullDescription(button) {
        var fullDesc = $(button).siblings('.full-description').html();
        $('.full-description-modal-content').html(fullDesc); // Set modal content to full description
        $('#fullDescriptionModal').modal('show'); // Show the modal
    }
